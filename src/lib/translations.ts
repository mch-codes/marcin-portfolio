export const translations = {
  es: {
    ...
    services: {
      ...
      card2_desc: "Una página que convierte visitas en clientes. Copy, diseño y código — todo incluido.",
  ...
  en: {
    ...
    services: {
      ...
      card2_desc: "A page that turns visitors into clients. Copy, design, and code — all included.",
