export const translations = {
  es: {
    ...
    about: {
      ...
      subtitle: "Webs que hacen que tu pieza se venda, no solo que se vea.",
      // One sentence per entry — the hero renders each on its own line.
      hero_sub: [
        "Webs para ceramistas, joyeros, marroquineros y talleres textiles de Madrid.",
        "Next.js, TypeScript, Supabase.",
        "Con un proyecto en producción real — Oidoo.app.",
  ...
  en: {
    ...
    about: {
      ...
      subtitle: "Websites that get your work sold, not just seen.",
      hero_sub: [
        "Websites for ceramicists, jewellers, leatherworkers and textile makers in Madrid.",
        "Next.js, TypeScript, Supabase.",
        "With one real production project — Oidoo.app.",
