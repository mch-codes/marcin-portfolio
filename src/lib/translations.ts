export const translations = {
  es: {
    ...
    about: {
      ...
      subtitle: "Conozco JavaScript, HTML y CSS lo suficientemente bien como para construir cosas reales. Ahora estoy aprendiendo React y Next.js en profundidad para entender las herramientas que he estado usando.",
  ...
  en: {
    ...
    about: {
      ...
      subtitle: "I know JavaScript, HTML and CSS well enough to build real things. I'm now learning React and Next.js properly so I understand the tools I've been using.",
