export const translations = {
  es: {
    ...
    services: {
      ...
      card1_price: "Desde €1.800–€2.000 · entrega en 2–3 semanas",
      card1_features: [
        "Hasta 5 páginas diseñadas desde cero",
        "Next.js + TypeScript — rápido y escalable",
      ...
      card2_price: "Desde €800–€900 · entrega en 1 semana",
      card2_features: [
      ...
      card3_features: [
        "Lógica, base de datos e interfaz — todo incluido",
        "Supabase + Next.js — stack probado en producción",
        "Autenticación, roles y permisos si los necesitas",
        "Desplegado en Vercel con CI/CD",
        "Soporte y mantenimiento disponible",
        "Hablamos primero — presupuesto en 24h",
      ],
    },
    whatIBuild: {
      title: "¿Qué construyo?",
  ...
  en: {
    ...
    services: {
      ...
      card1_price: "From €1,800–€2,000 · delivered in 2–3 weeks",
      card1_features: [
        "Up to 5 pages designed from scratch",
        "Next.js + TypeScript — fast and scalable",
      ...
      card2_price: "From €800–€900 · delivered in 1 week",
      card2_features: [
        "Custom design — no templates",
        "Responsive — mobile, tablet, and desktop",
        "Working contact form",
        "Optimised for speed and basic SEO",
        "Delivered in 7 days",
      ...
      card3_features: [
        "Logic, database, and interface — all included",
        "Supabase + Next.js — battle-tested stack",
        "Authentication, roles, and permissions if needed",
        "Deployed on Vercel with CI/CD",
        "Support and maintenance available",
        "Let's talk first — quote within 24h",
      ],
    },
    whatIBuild: {
      title: "What I build",
