export const translations = {
  es: {
    ...
    projects: {
      ...
      // The modal behind each card: who it was for, what I actually built.
      open_cta: "Ver capturas",
      close: "Cerrar",
      for_label: "Para quién",
      built_label: "Qué hice",
      stack_label: "Tecnología",
      hebras_for: "Una artesana de ganchillo en Madrid que vende por Instagram y WhatsApp.",
      hebras_built: "Web de una sola página, pensada primero para el móvil: portada, colección con foto y precio de cada pieza, y contacto directo a Instagram y WhatsApp.",
      almenos_for: "Un coleccionista y divulgador relojero que vende piezas vintage y escribe para prensa especializada.",
      almenos_built: "Catálogo ordenable con una ficha por reloj (año, estado, movimiento, precio), sección de prensa con sus artículos y enlaces a Instagram, YouTube y Vinted.",
      oidoo_for: "Cocinas profesionales: jefes de cocina y equipos que hoy trabajan en papel.",
      oidoo_built: "Producto propio de principio a fin: recetas con escandallo y food cost, los 14 alérgenos UE, checklists por estación, importación de recetas con IA y acceso para todo el equipo.",
  ...
  en: {
    ...
    projects: {
      ...
      almenos_name: "almenos1minuto",
      open_cta: "See screenshots",
      close: "Close",
      for_label: "For",
      built_label: "What I built",
      stack_label: "Stack",
      hebras_for: "A crochet maker in Madrid who sells through Instagram and WhatsApp.",
      hebras_built: "A one-page site, mobile first: hero, a collection with a photo and price for every piece, and contact straight to Instagram and WhatsApp.",
      almenos_for: "A watch collector and writer who sells vintage pieces and writes for the specialist press.",
      almenos_built: "A sortable catalogue with a page per watch (year, condition, movement, price), a press section for the published articles, and links to Instagram, YouTube and Vinted.",
      oidoo_for: "Professional kitchens: head chefs and teams still running on paper.",
      oidoo_built: "My own product end to end: recipes with costing and food cost, the 14 EU allergens, station checklists, AI recipe import, and access for the whole team.",
